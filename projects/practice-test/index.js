...
// 5. 
var dogsWithClasses = dogContestants.map(
    function(dog)
    { dog.weight <= 10 ? dog.class = 'red' : dog.weight <= 20 ? dog.class = 'yellow' : dog.class = 'green';
    return dog;});
...
// 7.
var votes = dogs.reduce((total, animal) => total + animal.votes, 0);